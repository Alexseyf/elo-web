...
export default function Evacuacao({ value, onChange }: EvacuacaoProps) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="hidden md:block text-xl font-semibold text-gray-800">Evacuação</h2>
      <p className="text-xs md:text-base text-gray-600 mb-6">Como foi a evacuação?</p>
